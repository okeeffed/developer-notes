...
<!-- TOC -->autoauto- [Advanced Networking](#advanced-networking)auto  - [IPv4 and Subnetting](#ipv4-and-subnetting)auto  - [VPN Fundamentals](#vpn-fundamentals)auto    - [Keys](#keys)auto    - [Auth Key Exchange](#auth-key-exchange)auto    - [Message intergrity](#message-intergrity)auto    - [Confidentiality](#confidentiality)auto    - [VPN Protocols](#vpn-protocols)auto    - [IPsec Process](#ipsec-process)auto    - [IKE Key Exchange](#ike-key-exchange)auto  - [Intro the BGP](#intro-the-bgp)auto    - [Terms](#terms)auto    - [About](#about)auto    - [BGP Requirements](#bgp-requirements)auto    - [BGP - Operation and Keep-Alive](#bgp---operation-and-keep-alive)auto    - [BFD - Bidirectional Forwarding Detection](#bfd---bidirectional-forwarding-detection)auto    - [BGP - Multi-Exit Discriminator](#bgp---multi-exit-discriminator)auto    - [BGP - AS_Path Prepending](#bgp---as_path-prepending)autoauto<!-- /TOC -->
